...
<html lang="en">
    ...
    <div class="container">
        ...
        <div class="card">
          ...
          @csrf
            ...
            <input type="text" name="kepada" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->kepada }}">
            </div>

            <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Bon/Faktur</label>
            <input type="text" name="bon_faktur" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->bon_faktur }}">
            </div>

            <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Banyak Barang</label>
            <input type="text" name="banyak_barang" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->banyak_barang }}">
            </div>
  ...
  <option value="2">Rim</option>
            ...
            <input type="text" name="jumlah" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->jumlah }}">
            </div>
